...
=== Deploy options (mina deploy <options>):

[precompile_assets=true]  forces precompile assets
...
NOTE: Need to set the following in config/environments/development.rb for this precompile method to work:
