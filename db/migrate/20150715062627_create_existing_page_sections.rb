class CreateExistingPageSections < ActiveRecord::Migration
  def up
    ...
    PageSection.create(
      ...
      content: "Azerbaijan's track record on human rights has deteriorated dramatically since 2012. This trend is most evident in the high number of politically motivated arrests, which have targeted human rights defenders, journalists and others. Here you can meet Azerbaijan's political prisoners, and you can explore the scope of Azerbaijan's efforts to stifle freedoms of expression."
    )
