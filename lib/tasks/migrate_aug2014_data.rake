namespace :aug2014_data do
  ...
  task :migrate => :environment do
    ...
    puts 'Migrating Azeri prisoner list data from lib/aug2014PdfParser/output into database; also transferring portraits from lib/aug2014PdfParser/portraits into public/system/portraits'
    require 'aug2014DataToDb'
    Aug2014DataToDb.migrate
    puts 'Finished prisoner list data into database and portraits into public/system/portraits'
  end
end
