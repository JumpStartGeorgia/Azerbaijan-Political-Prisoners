...
class ChargesControllerTest < ActionController::TestCase
  ...
  test "should create charge" do
    assert_difference('Charge.count') do
      post :create, charge: { criminal_code: @charge.criminal_code, description: @charge.description, number: @charge.number }
    end
  ...
  test "should update charge" do
    patch :update, id: @charge, charge: { criminal_code: @charge.criminal_code, description: @charge.description, number: @charge.number }
    assert_redirected_to charge_path(assigns(:charge))
  end
